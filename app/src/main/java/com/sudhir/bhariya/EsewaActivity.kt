    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pay.setOnClickListener {
            val eSewaPayment: ESewaPayment = ESewaPayment(
                ...
                "TruckHeavy",
                "3b5ssadeertrtrd1",
                "https://uat.esewa.com.np/mobile/transaction?txnRefId=$txnRefId",
    ...
    private fun saveTrip(){
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                val response = repository.saveTrip(Source = Source, Destination =Destination, Cost = Cost, Status = "Confirmed",  Date = Date,  ReferenceId = txnRefId, DriverId = DriverId, Vehicle= Vehicle, )
